...
export default function TeamingEngine() {
  ...
  if (status === 'complete' && result) {
    ...
    const lockActive = finalScore < 30; 
    ...
    return (
      <main className="flex min-h-screen flex-col items-center p-6 relative z-10 font-sans w-full max-w-7xl mx-auto">
        <header className="mb-12 mt-8 text-center w-full flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold font-outfit text-white tracking-widest uppercase">Teaming Pod Report</h1>
            <p className="text-gray-400 mt-2">Organization: <span className="text-brand-success font-mono">{result.niche || niche || 'Unknown'}</span></p>
          </div>
          <button onClick={handleReset} className="px-6 py-2 border border-white/20 text-white rounded hover:bg-white/10 transition-colors font-mono text-sm uppercase">Build New Pod</button>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full mb-8">
          ...
          <div className="p-6 rounded-2xl border border-white/10 bg-[#141419]/80 backdrop-blur-md shadow-2xl flex flex-col items-center">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6 w-full text-left">Pod Cohesion Score</h3>
          ...
          <div className="p-6 rounded-2xl border border-white/10 bg-[#141419]/80 backdrop-blur-md shadow-2xl lg:col-span-2 flex flex-col">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6 w-full text-left">Team Dynamics Radar</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
          ...
          <div className="p-6 rounded-2xl border border-white/10 bg-[#141419]/80 backdrop-blur-md shadow-2xl">
             <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">Historical Delivery</h3>
          ...
          {/* Gap Actions */}
          <div className="p-6 rounded-2xl border border-white/10 bg-[#141419]/80 backdrop-blur-md shadow-2xl">
             <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">Capacity Shortfalls</h3>
             <div className="w-full h-[300px]">
    ...
    <main className="flex min-h-screen flex-col items-center p-6 relative z-10 overflow-hidden font-sans">
      ...
      <div className="relative mb-12 flex flex-col items-center mt-12">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-white flex items-center gap-2 font-outfit">
          AI5K <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-purple to-brand-cyan">Organization Teaming</span>
        </h1>
        <p className="mt-2 text-gray-300 font-medium text-sm">
          Dynamic capability scoring and pod combination.
        </p>
      </div>
      ...
      <div className="p-8 w-full max-w-4xl flex flex-col mb-12 rounded-2xl border border-white/5 bg-[#141419]/60 backdrop-blur-xl shadow-2xl">
        <h2 className="text-2xl font-bold text-white mb-6 font-outfit">Build Delivery Pod</h2>
        
        {/* Row 1: 3 Columns */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Organization UUID</label>
            <input 
              type="text" 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Required Headcount</label>
            <input 
              type="text" 
              placeholder="3" 
              value={version}
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Pod Budget ($/hr)</label>
            <input 
              type="number" 
              placeholder="250" 
              value={rate}
        ...
        <div className="flex flex-col gap-2 mb-6">
          <label className="text-sm font-medium text-gray-400">Upload Roster CSV (Optional)</label>
          <div 
            ...
            onDrop={(e) => {
              ...
              if (droppedFile) {
                ...
                setErrorMsg('Please drop a valid file.');
              }
            }}
          >
            <input 
            ...
            {file ? (
              ...
              <div className="flex flex-col items-center text-gray-400">
                ...
                <span className="font-medium text-sm">Click to upload roster or drag and drop</span>
                <span className="text-xs text-gray-500 mt-1">CSV (MAX. 5MB)</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Target Timezones</label>
            <input 
              type="text" 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Exclusivity Toggle</label>
            <input 
              type="text" 
              placeholder="Strictly Exclusive" 
              value={upworkUrl}
        ...
        <div className="flex flex-col gap-2 mb-8">
          <label className="text-sm font-medium text-gray-400">Project Mission (Context)</label>
          <textarea 
            rows={3}
            placeholder="Describe the mission the pod needs to accomplish..." 
            value={cvText}
