    ...
    return (
      <main className="flex min-h-screen flex-col items-center p-6 relative z-10 font-sans w-full max-w-7xl mx-auto">
        <header className="mb-12 mt-8 text-center w-full flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold font-outfit text-white tracking-widest uppercase">Proposal Analysis Report</h1>
            <p className="text-gray-400 mt-2">Target Buyer: <span className="text-brand-blue font-mono">{result.niche || niche || 'Unknown'}</span></p>
          </div>
          <button onClick={handleReset} className="px-6 py-2 border border-white/20 text-white rounded hover:bg-white/10 transition-colors font-mono text-sm uppercase">Generate New Proposal</button>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full mb-8">
          ...
          <div className="p-6 rounded-2xl border border-white/10 bg-[#141419]/80 backdrop-blur-md shadow-2xl lg:col-span-2 flex flex-col">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6 w-full text-left">Pitch Tone Radar</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
          ...
          <div className="p-6 rounded-2xl border border-white/10 bg-[#141419]/80 backdrop-blur-md shadow-2xl">
             <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">Evidence Injected</h3>
          ...
          {/* Gap Actions */}
          <div className="p-6 rounded-2xl border border-white/10 bg-[#141419]/80 backdrop-blur-md shadow-2xl">
             <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">Missing Justifications</h3>
             <div className="w-full h-[300px]">
    ...
    <main className="flex min-h-screen flex-col items-center p-6 relative z-10 overflow-hidden font-sans">
      ...
      <div className="relative mb-12 flex flex-col items-center mt-12">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-white flex items-center gap-2 font-outfit">
          AI5K <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-purple to-brand-cyan">Proposal Workbench</span>
        </h1>
        <p className="mt-2 text-gray-300 font-medium text-sm">
          Evidence-backed XML proposal generation.
        </p>
      </div>
      ...
      <div className="p-8 w-full max-w-4xl flex flex-col mb-12 rounded-2xl border border-white/5 bg-[#141419]/60 backdrop-blur-xl shadow-2xl">
        <h2 className="text-2xl font-bold text-white mb-6 font-outfit">Generate Proposal</h2>
        
        {/* Row 1: 3 Columns */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Target Buyer/Client</label>
            <input 
              type="text" 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Proposed Rate ($/hr)</label>
            <input 
              type="number" 
              placeholder="150" 
              value={rate}
        ...
        <div className="flex flex-col gap-2 mb-6">
          <label className="text-sm font-medium text-gray-400">Upload Past Proposals (PDF)</label>
          <div 
          ...
          >
            ...
            {file ? (
              ...
              <div className="flex flex-col items-center text-gray-400">
                ...
                <span className="font-medium text-sm">Click to upload history or drag and drop</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Specific Case Study URL</label>
            <input 
              type="text" 
              placeholder="https://agency.com/case-study" 
              value={githubUrl}
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-400">Winning Claim IDs (Optional)</label>
            <input 
              type="text" 
              placeholder="c-102, c-105" 
              value={upworkUrl}
        ...
        <div className="flex flex-col gap-2 mb-8">
          <label className="text-sm font-medium text-gray-400">Custom Pitch Notes</label>
          <textarea 
            rows={3}
            placeholder="Ensure we emphasize our past experience with React and AI integration..." 
            value={cvText}
